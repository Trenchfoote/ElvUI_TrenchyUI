    ...
    profile = {
        ...
        nameplates = {
            ...
            importantCast = {
                ...
                scale = 1.0,
                healthColor = false,
                healthColorValue = { r = 1.0, g = 0.0, b = 0.0 },
                healthTexture = '',
                healthBorder = false,
                healthBorderColor = { r = 1.0, g = 0.0, b = 0.0, a = 1.0 },
                castbarColor = false,
                castbarColorValue = { r = 1.0, g = 0.8, b = 0.0 },
                castbarTexture = '',
                castbarBorder = false,
                castbarBorderColor = { r = 1.0, g = 0.8, b = 0.0, a = 1.0 },
            },
            hoverHighlight = {
                enabled = false,
                classColor = false,
