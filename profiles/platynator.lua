			...
			bars = {
				{
					...
					relativeTo = 0,
					anchor = {},
					foreground = { asset = "ElvUI Norm1" },
					background = { color = { a = 0.5650312304496765, r = 0, g = 0, b = 0 }, applyColor = false, asset = "ElvUI Norm1" },
					absorb = { color = { a = 0.7812488675117493, b = 1, g = 0.8431373238563538, r = 0.6705882549285889 }, asset = "ElvUI Norm1" },
					border = { height = 1.09, color = { a = 1, b = 0.4235294461250305, g = 0.4235294461250305, r = 0.4235294461250305 }, asset = "Platy: Blizzard Health", width = 1.12 },
					marker = { asset = "none" },
					autoColors = {
						{ kind = "execute", colors = { execute = { r = 0.8196079134941101, g = 0.1450980454683304, b = 0.760784387588501 } } },
						{ combatOnly = true, kind = "threat", instancesOnly = false, useSafeColor = false, colors = { safe = { r = 0.3686274588108063, g = 0.9019608497619628, b = 0.2431372702121735 }, warning = { r = 0.8, g = 0, b = 0 }, offtank = { r = 0.05882352941176471, g = 0.6666666666666666, b = 0.7843137254901961 }, transition = { r = 1, g = 0.6274509803921569, b = 0 } } },
						{ kind = "eliteType", instancesOnly = true, colors = { boss = { r = 1, g = 0, b = 0.6392157077789307 }, melee = { r = 0.988235354423523, g = 0.7647059559822083, b = 0.4862745404243469 }, caster = { b = 0.7372549019607844, g = 0.4549019607843137, r = 0 }, trivial = { b = 0.3333333333333333, g = 0.5568627450980392, r = 0.6980392156862745 }, miniboss = { b = 0.7372549019607844, g = 0, r = 0.5647058823529412 } } },
						{ kind = "tapped", colors = { tapped = { b = 0.4313725490196079, g = 0.4313725490196079, r = 0.4313725490196079 } } },
						{ kind = "classColors", colors = {} },
						{ kind = "reaction", colors = { unfriendly = { r = 1, g = 0.5058823529411765, b = 0 }, hostile = { r = 1, g = 0, b = 0 }, friendly = { r = 0, g = 1, b = 0 }, neutral = { r = 1, g = 1, b = 0 } } },
					},
				},
				{
					kind = "cast",
					...
					layer = 0,
					anchor = { "TOP", 0, -8.5 },
					foreground = { asset = "Blizzard Cast" },
					background = { color = { a = 1, b = 0.1764705926179886, g = 0.1764705926179886, r = 0.1764705926179886 }, applyColor = false, asset = "Blizzard Cast Background" },
					border = { height = 0.8, color = { a = 0.5, r = 1, g = 0.984313725490196, b = 0.3215686274509804 }, asset = "Platy: Blizzard Health", width = 1 },
					marker = { asset = "wide/glow" },
					interruptMarker = { color = { a = 1, b = 0.03921568766236305, g = 1, r = 0.1803921610116959 }, asset = "wide/glow" },
					autoColors = {
						{ kind = "interruptReady", colors = { ready = { r = 0, g = 1, b = 0 } } },
						{ kind = "uninterruptableCast", colors = { uninterruptable = { r = 0.5294117647058824, g = 0.5294117647058824, b = 0.5294117647058824 } } },
						{ kind = "cast", colors = { cast = { r = 1, g = 0.7411764705882353, b = 0 }, interrupted = { r = 0.9882352941176472, g = 0.211764705882353, b = 0.8784313725490196 }, channel = { r = 0.2431372549019608, g = 0.7764705882352941, b = 0.2156862745098039 } } },
					},
				},
			},
			highlights = {
				{
					...
					anchor = {},
					height = 1,
					color = { a = 1, b = 0.2392157018184662, g = 0.1843137294054031, r = 1 },
					sliced = true,
				},
				{
					kind = "automatic",
					...
					sliced = true,
					autoColors = {
						{ kind = "importantCast", colors = { cast = { a = 1, r = 1, g = 0.09411764705882352, b = 0.1529411764705883 }, channel = { a = 1, r = 1, g = 0.0941176563501358, b = 0.1529411822557449 } } },
						{ kind = "uninterruptableCast", colors = { uninterruptable = { a = 1, r = 0.5137254901960784, g = 0.7529411764705882, b = 0.7647058823529411 } } },
					},
				},
				{
					kind = "target",
				...
				},
				{
					...
					scale = 1,
					layer = 1,
					asset = "Platy: Arrows In",
					width = 1,
					anchor = {},
					height = 0.76,
					color = { a = 1, r = 0.5254902243614197, g = 1, b = 0.6745098233222961 },
					sliced = false,
				},
			},
			specialBars = {},
			auras = {
				{
					...
					anchor = { "BOTTOMRIGHT", 62, 9 },
					textScale = 1,
					filters = { important = true, fromYou = true },
				},
				{
					kind = "buffs",
					direction = "RIGHT",
				...
				},
				{
					...
					height = 0.75,
					showDispel = {},
					anchor = { "BOTTOMLEFT", -16, 9 },
					textScale = 1,
					filters = { fromYou = false },
				},
			},
			markers = {
				{ kind = "quest", asset = "normal/quest-blizzard", anchor = { "LEFT", -70, 0 }, color = { r = 1, g = 1, b = 1 }, scale = 0.9, layer = 3 },
				{ kind = "cannotInterrupt", asset = "normal/blizzard-shield", anchor = { "TOPLEFT", -63.5, -8.5 }, color = { r = 1, g = 1, b = 1 }, scale = 0.66, layer = 2 },
				{ kind = "raid", asset = "normal/blizzard-raid", anchor = {}, color = { r = 1, g = 1, b = 1 }, scale = 1, layer = 3 },
			},
			texts = {
				{ kind = "health", truncate = false, align = "CENTER", layer = 2, maxWidth = 0, significantFigures = 0, displayTypes = { "percentage" }, anchor = { "RIGHT", 60.5, 0 }, scale = 0.8, color = { r = 1, g = 1, b = 1 } },
				{ kind = "creatureName", showWhenWowDoes = false, truncate = true, align = "LEFT", layer = 2, maxWidth = 0.75, autoColors = {}, anchor = { "LEFT", -58, 0 }, scale = 0.8, color = { b = 1, g = 1, r = 1 } },
				{ kind = "castSpellName", anchor = { "TOPLEFT", -57.5, -11 }, scale = 0.7, truncate = true, align = "LEFT", layer = 2, color = { r = 1, g = 1, b = 1 }, maxWidth = 0.44 },
				{ kind = "castTarget", truncate = true, align = "LEFT", layer = 2, maxWidth = 0.46, color = { r = 1, g = 1, b = 1 }, anchor = { "TOPLEFT", -57, -21.5 }, scale = 0.7, applyClassColors = true },
				{ kind = "castTimeLeft", color = { r = 1, g = 1, b = 1 }, scale = 0.8, truncate = false, anchor = { "TOPRIGHT", 57.5, -11 }, layer = 2, align = "CENTER", maxWidth = 0 },
			},
		},
		["ElvUI"] = {
			version = 1,
			...
			bars = {
				{
					...
					border = { color = { a = 1, r = 0, g = 0, b = 0 }, height = 1.09, asset = "Platy: 1px", width = 1.12 },
					marker = { asset = "none" },
					autoColors = {
				...
				},
				{
					...
					border = { color = { a = 0.5, r = 0, g = 0, b = 0 }, height = 0.8, asset = "Platy: 1px", width = 1 },
					marker = { asset = "wide/glow" },
			...
			highlights = {
				...
				},
				{
					...
					anchor = {},
					height = 0.8,
					color = { a = 1, b = 0.4470588564872742, g = 0.4549019932746887, r = 0.4470588564872742 },
					sliced = false,
				},
			},
			specialBars = {},
			...
			markers = {
				{ kind = "quest", asset = "normal/quest-blizzard", scale = 0.9, anchor = { "LEFT", -70, 0 }, color = { b = 1, g = 1, r = 1 }, layer = 3 },
				{ kind = "cannotInterrupt", asset = "normal/blizzard-shield", scale = 0.66, anchor = { "TOPLEFT", -63.5, -8.5 }, color = { b = 1, g = 1, r = 1 }, layer = 2 },
				{ kind = "raid", asset = "normal/blizzard-raid", scale = 1, anchor = {}, color = { b = 1, g = 1, r = 1 }, layer = 3 },
			},
			texts = {
				{ kind = "health", truncate = false, color = { b = 1, g = 1, r = 1 }, layer = 2, maxWidth = 0, significantFigures = 0, align = "CENTER", anchor = { "RIGHT", 60.5, 0 }, scale = 0.8, displayTypes = { "percentage" } },
				{ kind = "creatureName", showWhenWowDoes = false, truncate = true, align = "LEFT", layer = 2, maxWidth = 0.75, autoColors = {}, anchor = { "LEFT", -58, 0 }, color = { r = 1, g = 1, b = 1 }, scale = 0.8 },
				{ kind = "castSpellName", scale = 0.7, color = { b = 1, g = 1, r = 1 }, layer = 2, truncate = true, anchor = { "TOPLEFT", -57.5, -11 }, align = "LEFT", maxWidth = 0.44 },
				{ kind = "castTarget", truncate = true, color = { b = 1, g = 1, r = 1 }, layer = 2, maxWidth = 0.46, align = "LEFT", anchor = { "TOPLEFT", -57, -21.5 }, scale = 0.7, applyClassColors = true },
				{ kind = "castTimeLeft", scale = 0.8, align = "CENTER", layer = 2, truncate = false, color = { b = 1, g = 1, r = 1 }, anchor = { "TOPRIGHT", 57.5, -11 }, maxWidth = 0 },
			},
		},
	}
