...
local function SetupProfileDB()
    ...
    E.db.movers.PetAB = "BOTTOM,ElvUIParent,BOTTOM,-252,319"
    ...
    E.db.nameplates.units.ENEMY_NPC.buffs.numAuras = 20
...
local function SetupTrenchyUI()
    ...
    E.db.TrenchyUI.cooldownManager.selectedViewer = "custom"
    ...
    E.db.TrenchyUI.cooldownManager.viewers.buffBar.nameText.fontSize = 10
    ...
    E.db.TrenchyUI.platynator.hidePercentSign = true
