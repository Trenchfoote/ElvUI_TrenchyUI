...
- Damage Meter: Fixed bars showing stale data after auto-reset until next combat event
- Damage Meter: Fixed drilldown not receiving secret GUID data from bar clicks
